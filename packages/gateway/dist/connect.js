...
export async function connect(host, profile) {
    ...
    try {
        ...
        console.error(`Refusing to edit ${path}: it does not parse as JSON (${e.message}). Fix or remove the file first.`);
        return 5;
    }
