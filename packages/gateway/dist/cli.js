        ...
        switch (verb) {
            ...
            case 'tools': {
                ...
                if (sub === 'call') {
                    ...
                    if (status === 402) {
                        console.error(`${codeOf(body)}: ${body?.error?.message}`);
                        return 4;
                    }
